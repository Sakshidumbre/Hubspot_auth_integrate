...
@app.options('/integrations/airtable/authorize')
async def options_airtable_authorize():
...
@app.options('/integrations/notion/authorize')
async def options_notion_authorize():
    return JSONResponse(status_code=200, headers={
        "Access-Control-Allow-Origin": "*",
        "Access-Control-Allow-Methods": "POST, OPTIONS",
        "Access-Control-Allow-Headers": "Content-Type, Authorization"
...
@app.options('/integrations/hubspot/authorize')
async def options_hubspot_authorize():
    return JSONResponse(status_code=200, headers={
        "Access-Control-Allow-Origin": "*",
        "Access-Control-Allow-Methods": "POST, OPTIONS",
        "Access-Control-Allow-Headers": "Content-Type, Authorization"
